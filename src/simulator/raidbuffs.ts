...
export const RAID_BUFFS: Buff[] = [
    ...
    // },
    // {
    //     statusID: RAIDBUFFS.STATUSES.THE_BALANCE.id,
    //     potency: 1.06,
    // },
    // {
    //     statusID: RAIDBUFFS.STATUSES.THE_BOLE.id,
    //     potency: 1.06,
    // },
    // {
    //     statusID: RAIDBUFFS.STATUSES.THE_ARROW.id,
    //     potency: 1.06,
    // },
    // {
    //     statusID: RAIDBUFFS.STATUSES.THE_SPEAR.id,
    //     potency: 1.06,
    // },
    // {
    //     statusID: RAIDBUFFS.STATUSES.THE_EWER.id,
    //     potency: 1.06,
    // },
    // {
    //     statusID: RAIDBUFFS.STATUSES.THE_SPIRE.id,
    //     potency: 1.06,
    // },
]
